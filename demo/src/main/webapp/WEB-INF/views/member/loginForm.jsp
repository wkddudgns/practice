...
<div class="card border-primary mb-3" style="max-width: 50rem;" align="center" >
  ...
  <div class="card-body">
    ...
    <p class="card-text"><form action="/member/login" method="post">
		ID <input type="text" class="form-control" id="email" name="email"> <br>
		PW <input type="password" class="form-control" id="password" name="password"> <br>
