...
<div class="card border-primary mb-3" style="max-width: 50rem;" align="center" >
  ...
  <div class="card-body">
    ...
    <p class="card-text"><form action = "/member/countryCheck2" method="get">
Country : <select name="phoneCountry" id="phoneCountry">
			<option value="82">Korea</option>
		</select>



Number : <input type="text" id="phoneNumber" name="phoneNumber">
